...
{
public:
	VulkanSimpleRenderPass(VulkanContext* context, VulkanSwapChain* swapchain);
	~VulkanSimpleRenderPass() override;
...
class VulkanSimpleGraphicsPipeline : public VulkanGraphicsPipeline
{
public:
	VulkanSimpleGraphicsPipeline(VulkanContext* context, VulkanRenderPass* pass, VkExtent2D extent);
	~VulkanSimpleGraphicsPipeline() override;
